...
public class Entity<K extends National> extends Country implements Cloneable {
    String nameOrg;
    int countClient;
    private K guid;
    public K getGuid() {
    ...
    Entity(String name, int people, int indexCritic, String nameOrg, int countClient, K guid) {
